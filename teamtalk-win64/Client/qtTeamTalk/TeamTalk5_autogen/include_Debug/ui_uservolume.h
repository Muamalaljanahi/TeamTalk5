...
public:
    ...
    void setupUi(QDialog *UserVolumeDlg)
    {
        if (UserVolumeDlg->objectName().isEmpty())
            UserVolumeDlg->setObjectName("UserVolumeDlg");
        ...
        voicevolSlider->setObjectName("voicevolSlider");
        ...
        voiceleftChkBox->setObjectName("voiceleftChkBox");

        horizontalLayout->addWidget(voiceleftChkBox);

        voicerightChkBox = new QCheckBox(groupBox);
        voicerightChkBox->setObjectName("voicerightChkBox");
        ...
        mfvolSlider->setObjectName("mfvolSlider");
        ...
        mfleftChkBox->setObjectName("mfleftChkBox");

        horizontalLayout_3->addWidget(mfleftChkBox);

        mfrightChkBox = new QCheckBox(groupBox_4);
        mfrightChkBox->setObjectName("mfrightChkBox");
        ...
        QObject::connect(buttonBox, &QDialogButtonBox::accepted, UserVolumeDlg, qOverload<>(&QDialog::accept));
        QObject::connect(buttonBox, &QDialogButtonBox::rejected, UserVolumeDlg, qOverload<>(&QDialog::reject));
