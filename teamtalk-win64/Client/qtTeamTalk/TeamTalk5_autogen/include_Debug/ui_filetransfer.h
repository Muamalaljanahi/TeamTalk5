...
public:
    ...
    void setupUi(QDialog *FileTransferDlg)
    {
        if (FileTransferDlg->objectName().isEmpty())
            FileTransferDlg->setObjectName("FileTransferDlg");
        ...
        filenameLabel->setFocusPolicy(Qt::StrongFocus);

        formLayout->setWidget(0, QFormLayout::ItemRole::FieldRole, filenameLabel);
        ...
        filesizeLabel->setFocusPolicy(Qt::StrongFocus);

        formLayout->setWidget(1, QFormLayout::ItemRole::FieldRole, filesizeLabel);
        ...
        throughputLabel->setObjectName("throughputLabel");
        throughputLabel->setText(QString::fromUtf8("TextLabel"));
        throughputLabel->setFocusPolicy(Qt::StrongFocus);

        formLayout->setWidget(2, QFormLayout::ItemRole::FieldRole, throughputLabel);
        ...
        destinationLabel->setFocusPolicy(Qt::StrongFocus);

        formLayout->setWidget(3, QFormLayout::ItemRole::FieldRole, destinationLabel);
        ...
        closeChkBox->setObjectName("closeChkBox");
    ...
    void retranslateUi(QDialog *FileTransferDlg)
    {
        ...
        progressBar->setAccessibleName(QCoreApplication::translate("FileTransferDlg", "Transfer progress", nullptr));
