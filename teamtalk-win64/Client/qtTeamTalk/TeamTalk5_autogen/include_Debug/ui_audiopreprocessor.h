...
public:
    ...
    void setupUi(QDialog *AudioPreprocessorDlg)
    {
        if (AudioPreprocessorDlg->objectName().isEmpty())
            AudioPreprocessorDlg->setObjectName("AudioPreprocessorDlg");
        ...
        agcCheckBox->setObjectName("agcCheckBox");
        ...
        spxDefaultButton->setObjectName("spxDefaultButton");
        ...
        gainlevelSpinBox->setObjectName("gainlevelSpinBox");
        ...
        maxgainSpinBox->setObjectName("maxgainSpinBox");
        ...
        maxincSpinBox->setObjectName("maxincSpinBox");
        ...
        maxdecSpinBox->setObjectName("maxdecSpinBox");
        ...
        denoiseCheckBox->setObjectName("denoiseCheckBox");
        ...
        maxdenoiseSpinBox->setObjectName("maxdenoiseSpinBox");
        ...
        ttdefaultButton->setObjectName("ttdefaultButton");
        ...
        muteleftCheckBox->setObjectName("muteleftCheckBox");

        horizontalLayout_2->addWidget(muteleftCheckBox);

        muteRightCheckBox = new QCheckBox(page_2);
        muteRightCheckBox->setObjectName("muteRightCheckBox");
        ...
        verticalSpacer = new QSpacerItem(266, 176, QSizePolicy::Policy::Minimum, QSizePolicy::Policy::Expanding);
        ...
        label->setBuddy(gainlevelSlider);
#endif // QT_CONFIG(shortcut)

        retranslateUi(AudioPreprocessorDlg);
        QObject::connect(buttonBox, &QDialogButtonBox::accepted, AudioPreprocessorDlg, qOverload<>(&QDialog::accept));
        QObject::connect(buttonBox, &QDialogButtonBox::rejected, AudioPreprocessorDlg, qOverload<>(&QDialog::reject));
